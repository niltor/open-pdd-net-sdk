...
namespace PddOpenSdk.AspNetCore
{
    ...
    public class PddService
    {
		...
		/// 图像工具API
		/// </summary>
		public PictureToolApi PictureToolApi { get; }
        ...
        public PddService(IOptions<PddOptions> options, ILogger<PddService> logger)
        {
			...
			PictureToolApi = new PictureToolApi(_options.ClientId, _options.ClientSecret, _options.AccessToken);
        ...
        public PddService(PddOptions options)
        {
			...
			PictureToolApi = new PictureToolApi(options.ClientId, options.ClientSecret, options.AccessToken);
        ...
        protected void SetToken(string accessToken)
        {
			...
			PictureToolApi.AccessToken = accessToken;
