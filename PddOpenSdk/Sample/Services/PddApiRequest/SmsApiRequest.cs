...
dic.Add("mall_visit_days",MallVisitDays);
    ...
    var result = await PostAsync<QuerySmsCrowdsPeopleNumberApiResult>("pdd.sms.crowds.people.number.query",dic);
    return result;
}/// <summary>
/// 查询人群列表
/// </summary>
...
dic.Add("page_size",PageSize);
    ...
    var result = await PostAsync<QuerySmsCrowdsApiResult>("pdd.sms.crowds.query",dic);
    return result;
}/// <summary>
/// 指定号码短信发送设置（自定义）
/// </summary>
...
dic.Add("template_type",TemplateType);
    ...
    var result = await PostAsync<SettingSmsCustomApiResult>("pdd.sms.custom.setting",dic);
    return result;
}/// <summary>
/// 自定义模板查询
/// </summary>
...
/// <param name="TemplateType">/**;      * 自定义模板类型;      * 0,正常模板;      * 1,需要带优惠券类型的模板;      */</param>
...
dic.Add("template_type",TemplateType);
    ...
    var result = await PostAsync<QuerySmsCustomTemplateApiResult>("pdd.sms.custom.template.query",dic);
    return result;
}/// <summary>
/// 查询余量
/// </summary>
public async Task<QuerySmsRemainDetailApiResult> QuerySmsRemainDetailAsync()
{
    ...
    var result = await PostAsync<QuerySmsRemainDetailApiResult>("pdd.sms.remain.detail.query",dic);
    return result;
}/// <summary>
/// 提醒买家付款的任务设置
/// </summary>
...
dic.Add("template_id",TemplateId);
    ...
    var result = await PostAsync<SettingSmsRemainApiResult>("pdd.sms.remain.setting",dic);
    return result;
}/// <summary>
/// 提醒类短信设置详情
/// </summary>
...
public async Task<QuerySmsRemainSettingDetailApiResult> QuerySmsRemainSettingDetailAsync(int Scene)
{
    ...
    var result = await PostAsync<QuerySmsRemainSettingDetailApiResult>("pdd.sms.remain.setting.detail.query",dic);
    return result;
}/// <summary>
/// 删除任务
/// </summary>
...
public async Task<DeletingSmsSellApiResult> DeletingSmsSellAsync(int Id)
{
    ...
    var result = await PostAsync<DeletingSmsSellApiResult>("pdd.sms.sell.deleting",dic);
    return result;
}/// <summary>
/// 查询短信发送任务列表
/// </summary>
/// <param name="Status">全部不传status; 待发送 status 1; 已发送 status2; 已取消 status3</param>
...
dic.Add("page_size",PageSize);
    ...
    var result = await PostAsync<QuerySmsSellRecordListApiResult>("pdd.sms.sell.record.list.query",dic);
    return result;
}/// <summary>
/// 营销短信设置详情
/// </summary>
...
public async Task<QuerySmsSellSettingDetailApiResult> QuerySmsSellSettingDetailAsync(int Id)
{
    ...
    var result = await PostAsync<QuerySmsSellSettingDetailApiResult>("pdd.sms.sell.setting.detail.query",dic);
    return result;
}/// <summary>
/// 取消任务
/// </summary>
...
public async Task<CancelSmsSellSettingRecordApiResult> CancelSmsSellSettingRecordAsync(int Id)
{
    ...
    var result = await PostAsync<CancelSmsSellSettingRecordApiResult>("pdd.sms.sell.setting.record.cancel",dic);
    return result;
}/// <summary>
/// 短信发送记录列表
/// </summary>
...
dic.Add("page_size",PageSize);
    ...
    var result = await PostAsync<QuerySmsSendRecordListApiResult>("pdd.sms.send.record.list.query",dic);
    return result;
}/// <summary>
/// 查看任务数据
/// </summary>
...
public async Task<QuerySmsShortStatisticApiResult> QuerySmsShortStatisticAsync(int SettingId)
{
    ...
    var result = await PostAsync<QuerySmsShortStatisticApiResult>("pdd.sms.short.statistic.query",dic);
    return result;
}/// <summary>
/// 查询官方模板
/// </summary>
/// <param name="Scene">0, "优惠券", ; 1, "提醒付款", ; 2, "活动营销", ; 3, "召唤买家成团", ; 4, "新客转化", ; 5, "老客召回", ; 6, "流失唤醒", ; 7, "用户自定义", ; 8, "个性化营销", ; 9, "精准客户推送"</param>
public async Task<QuerySmsTemplateApiResult> QuerySmsTemplateAsync(int Scene)
{
    var dic = new Dictionary<string, object>();
    dic.Add("scene",Scene);
    
    var result = await PostAsync<QuerySmsTemplateApiResult>("pdd.sms.template.query",dic);
    return result;
}
    }
}
