...
dic.Add("page",Page);
    ...
    var result = await PostAsync<GetDdkOauthAppNewBillListApiResult>("pdd.ddk.oauth.app.new.bill.list.get",dic);
    return result;
}/// <summary>
/// 生成商城推广链接接口
/// </summary>
...
public async Task<GenerateDdkOauthCmsPromUrlApiResult> GenerateDdkOauthCmsPromUrlAsync(string PIdList,int ChannelType,bool GenerateShortUrl,bool GenerateMobile,bool MultiGroup,string CustomParameters,bool GenerateWeappWebview,bool WeAppWebViewShortUrl,bool WeAppWebWiewUrl)
{
    var dic = new Dictionary<string, object>();
...
dic.Add("we_app_web_wiew_url",WeAppWebWiewUrl);
    ...
    var result = await PostAsync<GenerateDdkOauthCmsPromUrlApiResult>("pdd.ddk.oauth.cms.prom.url.generate",dic);
    return result;
}/// <summary>
/// 多多进宝推广位创建接口
/// </summary>
...
dic.Add("p_id_name_list",PIdNameList);
    ...
    var result = await PostAsync<GenerateDdkOauthGoodsPidApiResult>("pdd.ddk.oauth.goods.pid.generate",dic);
    return result;
}/// <summary>
/// 多多客已生成推广位信息查询
/// </summary>
...
dic.Add("page_size",PageSize);
    ...
    var result = await PostAsync<QueryDdkOauthGoodsPidApiResult>("pdd.ddk.oauth.goods.pid.query",dic);
    return result;
}/// <summary>
/// 生成多多进宝推广链接
/// </summary>
...
public async Task<GenerateDdkOauthGoodsPromUrlApiResult> GenerateDdkOauthGoodsPromUrlAsync(string Type,string PId,string GoodsIdList,bool GenerateShortUrl,bool MultiGroup,string CustomParameters,bool PullNew,bool GenerateWeappWebview,int ZsDuoId)
{
    var dic = new Dictionary<string, object>();
    dic.Add("type",Type);
dic.Add("p_id",PId);
...
dic.Add("zs_duo_id",ZsDuoId);
    ...
    var result = await PostAsync<GenerateDdkOauthGoodsPromUrlApiResult>("pdd.ddk.oauth.goods.prom.url.generate",dic);
    return result;
}/// <summary>
/// 生成招商推广链接
/// </summary>
...
dic.Add("pid",Pid);
    ...
    var result = await PostAsync<GenDdkOauthGoodsZsUnitUrlApiResult>("pdd.ddk.oauth.goods.zs.unit.url.gen",dic);
    return result;
}/// <summary>
/// 多多客工具查询转盘拉新订单列表
/// </summary>
...
dic.Add("customer_paramters",CustomerParamters);
    ...
    var result = await PostAsync<GetDdkOauthLotteryNewListApiResult>("pdd.ddk.oauth.lottery.new.list.get",dic);
    return result;
}/// <summary>
/// 多多客工具生成转盘抽免单url
/// </summary>
...
dic.Add("customer_paramters",CustomerParamters);
    ...
    var result = await PostAsync<GenDdkOauthLotteryUrlApiResult>("pdd.ddk.oauth.lottery.url.gen",dic);
    return result;
}/// <summary>
/// 多多客工具生成店铺优惠券推广链接API
/// </summary>
...
/// <param name="GenerateShortUrl">是否生成短链接，true-是，false-否</param>
/// <param name="MultiGroup">true--生成多人团推广链接 false--生成单人团推广链接（默认false）1、单人团推广链接：用户访问单人团推广链接，可直接购买商品无需拼团。2、多人团推广链接：用户访问双人团推广链接开团，若用户分享给他人参团，则开团者和参团者的佣金均结算给推手</param>
public async Task<GenDdkOauthMallCouponUrlApiResult> GenDdkOauthMallCouponUrlAsync(int MallId,string Pid,string CouponIds,bool GenerateWeappWebview,bool GenerateShortUrl,bool MultiGroup)
{
    var dic = new Dictionary<string, object>();
...
dic.Add("multi_group",MultiGroup);
    ...
    var result = await PostAsync<GenDdkOauthMallCouponUrlApiResult>("pdd.ddk.oauth.mall.coupon.url.gen",dic);
    return result;
}/// <summary>
/// 多多客工具生成店铺推广链接API
/// </summary>
...
/// <param name="GenerateShortUrl">是否生成短链接，true-是，false-否</param>
/// <param name="MultiGroup">true--生成多人团推广链接 false--生成单人团推广链接（默认false）1、单人团推广链接：用户访问单人团推广链接，可直接购买商品无需拼团。2、多人团推广链接：用户访问双人团推广链接开团，若用户分享给他人参团，则开团者和参团者的佣金均结算给推手</param>
public async Task<GenDdkOauthMallUrlApiResult> GenDdkOauthMallUrlAsync(int MallId,string Pid,bool GenerateWeappWebview,bool GenerateShortUrl,bool MultiGroup)
{
    var dic = new Dictionary<string, object>();
    dic.Add("mall_id",MallId);
dic.Add("pid",Pid);
...
dic.Add("multi_group",MultiGroup);
    ...
    var result = await PostAsync<GenDdkOauthMallUrlApiResult>("pdd.ddk.oauth.mall.url.gen",dic);
    return result;
}/// <summary>
/// 获取订单详情
/// </summary>
...
public async Task<GetDdkOauthOrderDetailApiResult> GetDdkOauthOrderDetailAsync(string OrderSn)
{
    ...
    var result = await PostAsync<GetDdkOauthOrderDetailApiResult>("pdd.ddk.oauth.order.detail.get",dic);
    return result;
}/// <summary>
/// 按照更新时间段增量同步推广订单信息
/// </summary>
...
dic.Add("page",Page);
    ...
    var result = await PostAsync<GetDdkOauthOrderListIncrementApiResult>("pdd.ddk.oauth.order.list.increment.get",dic);
    return result;
}/// <summary>
/// 生成红包推广链接接口
/// </summary>
...
/// <param name="WeAppWebViewShortUrl">唤起微信app推广短链接</param>
/// <param name="WeAppWebWiewUrl">唤起微信app推广链接</param>
public async Task<GenerateDdkOauthRpPromUrlApiResult> GenerateDdkOauthRpPromUrlAsync(string PIdList,bool GenerateWeappWebview,bool GenerateShortUrl,string CustomParameters,bool WeAppWebViewShortUrl,bool WeAppWebWiewUrl)
{
    var dic = new Dictionary<string, object>();
    dic.Add("p_id_list",PIdList);
dic.Add("generate_weapp_webview",GenerateWeappWebview);
...
dic.Add("we_app_web_wiew_url",WeAppWebWiewUrl);
    ...
    var result = await PostAsync<GenerateDdkOauthRpPromUrlApiResult>("pdd.ddk.oauth.rp.prom.url.generate",dic);
    return result;
}/// <summary>
/// 多多进宝主题推广链接生成接口
/// </summary>
...
/// <param name="WeAppWebViewShortUrl">唤起微信app推广短链接</param>
/// <param name="WeAppWebWiewUrl">唤起微信app推广链接</param>
public async Task<GenerateDdkOauthThemePromUrlApiResult> GenerateDdkOauthThemePromUrlAsync(string Type,string Pid,string ThemeIdList,bool GenerateShortUrl,bool GenerateMobile,string CustomParameters,bool GenerateWeappWebview,bool WeAppWebViewShortUrl,bool WeAppWebWiewUrl)
{
    var dic = new Dictionary<string, object>();
    dic.Add("type",Type);
dic.Add("pid",Pid);
...
dic.Add("we_app_web_wiew_url",WeAppWebWiewUrl);
    ...
    var result = await PostAsync<GenerateDdkOauthThemePromUrlApiResult>("pdd.ddk.oauth.theme.prom.url.generate",dic);
    return result;
}/// <summary>
/// 多多客工具生成单品推广小程序二维码
/// </summary>
...
dic.Add("zs_duo_id",ZsDuoId);
    ...
    var result = await PostAsync<GenDdkOauthWeappQrcodeUrlApiResult>("pdd.ddk.oauth.weapp.qrcode.url.gen",dic);
    return result;
}/// <summary>
/// 查询招商推广计划商品接口
/// </summary>
...
dic.Add("page",Page);
    ...
    var result = await PostAsync<QueryDdkOauthZsUnitGoodsApiResult>("pdd.ddk.oauth.zs.unit.goods.query",dic);
    return result;
}
    }
}
