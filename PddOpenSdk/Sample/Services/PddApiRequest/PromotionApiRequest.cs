...
public async Task<ClosePromotionCouponApiResult> ClosePromotionCouponAsync(int BatchId)
{
    ...
    var result = await PostAsync<ClosePromotionCouponApiResult>("pdd.promotion.coupon.close",dic);
    return result;
}/// <summary>
/// 增加优惠券发行数量接口
/// </summary>
...
dic.Add("add_quantity",AddQuantity);
    ...
    var result = await PostAsync<AddPromotionCouponQuantityApiResult>("pdd.promotion.coupon.quantity.add",dic);
    return result;
}/// <summary>
/// 创建无门槛商品劵批次接口
/// </summary>
...
dic.Add("goods_id",GoodsId);
    ...
    var result = await PostAsync<CreatePromotionGoodsCouponApiResult>("pdd.promotion.goods.coupon.create",dic);
    return result;
}/// <summary>
/// 商品优惠券批次列表查询
/// </summary>
...
dic.Add("sort_by",SortBy);
    ...
    var result = await PostAsync<GetPromotionGoodsCouponListApiResult>("pdd.promotion.goods.coupon.list.get",dic);
    return result;
}/// <summary>
/// 创建店铺首页优惠券批次接口
/// </summary>
...
dic.Add("user_limit",UserLimit);
    ...
    var result = await PostAsync<CreatePromotionHomeCouponApiResult>("pdd.promotion.home.coupon.create",dic);
    return result;
}/// <summary>
/// 店铺优惠券批次列表接口
/// </summary>
...
dic.Add("sort_by",SortBy);
    ...
    var result = await PostAsync<GetPromotionMerchantCouponListApiResult>("pdd.promotion.merchant.coupon.list.get",dic);
    return result;
}
    }
}
