...
public async Task<GetLogisticsCsHistoryMessageApiResult> GetLogisticsCsHistoryMessageAsync(string(64) SessionId)
{
    ...
    var result = await PostAsync<GetLogisticsCsHistoryMessageApiResult>("pdd.logistics.cs.history.message.get",dic);
    return result;
}/// <summary>
/// 客服给发消息接口
/// </summary>
...
dic.Add("preview",Preview);
    ...
    var result = await PostAsync<SendLogisticsCsMessageApiResult>("pdd.logistics.cs.message.send",dic);
    return result;
}/// <summary>
/// 客服关闭会话接口
/// </summary>
...
dic.Add("action_time",ActionTime);
    ...
    var result = await PostAsync<CloseLogisticsCsSessionApiResult>("pdd.logistics.cs.session.close",dic);
    return result;
}/// <summary>
/// 物流客服系统创建同步会话状态接口
/// </summary>
...
dic.Add("exception_msg",ExceptionMsg);
    ...
    var result = await PostAsync<StartLogisticsCsSessionApiResult>("pdd.logistics.cs.session.start",dic);
    return result;
}/// <summary>
/// 快递公司工单查询接口
/// </summary>
...
dic.Add("page_size",PageSize);
    ...
    var result = await PostAsync<GetLogisticsTicketApiResult>("pdd.logistics.ticket.get",dic);
    return result;
}/// <summary>
/// 工单图片上传接口
/// </summary>
...
public async Task<UploadLogisticsTicketImageApiResult> UploadLogisticsTicketImageAsync(string Image)
{
    ...
    var result = await PostAsync<UploadLogisticsTicketImageApiResult>("pdd.logistics.ticket.image.upload",dic);
    return result;
}/// <summary>
/// 快递公司处理结果回调接口
/// </summary>
...
dic.Add("express_dealer_contact",ExpressDealerContact);
    ...
    var result = await PostAsync<NotifyLogisticsTicketApiResult>("pdd.logistics.ticket.notify",dic);
    return result;
}/// <summary>
/// 快递公司工单问题类型列表接口
/// </summary>
...
public async Task<GetLogisticsTicketProblemTypeApiResult> GetLogisticsTicketProblemTypeAsync(string Type)
{
    ...
    var result = await PostAsync<GetLogisticsTicketProblemTypeApiResult>("pdd.logistics.ticket.problem.type.get",dic);
    return result;
}
    }
}
