...
public string CostTemplateList {get;set;}
/// <summary>
/// 包邮地区
/// </summary>
[JsonProperty("free_province_list")]
public string FreeProvinceList {get;set;}
/// <summary>
/// 送货入户区域
/// </summary>
[JsonProperty("free_deliver_house_area_list")]
public string FreeDeliverHouseAreaList {get;set;}
/// <summary>
/// 计费方式，0-按件计费，1-按重量计费
/// </summary>
...
public string CostProvinceList {get;set;}
/// <summary>
/// 省份ID
/// </summary>
