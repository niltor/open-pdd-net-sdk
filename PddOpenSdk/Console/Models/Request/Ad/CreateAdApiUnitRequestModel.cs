...
{
public partial class CreateAdApiUnitRequestModel : PddRequestModel
{
/// <summary>
/// 单元创建信息
/// </summary>
[JsonProperty("adUnitCreateComplexMessage")]
public AdUnitCreateComplexMessageRequestModel AdUnitCreateComplexMessage {get;set;}
/// <summary>
/// 广告计划Id
/// </summary>
[JsonProperty("planId")]
...
public partial class AdUnitCreateComplexMessageRequestModel : PddRequestModel
{
/// <summary>
/// 创意创建信息列表
/// </summary>
