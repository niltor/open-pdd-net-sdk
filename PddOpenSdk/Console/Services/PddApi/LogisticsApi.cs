...
/// ISV物流轨迹推送消息订阅接口
/// </summary>
public async Task<SubLogisticsIsvTraceNotifyResponseModel> SubLogisticsIsvTraceNotifyAsync(SubLogisticsIsvTraceNotifyRequestModel subLogisticsIsvTraceNotify)
{
    var result = await PostAsync<SubLogisticsIsvTraceNotifyRequestModel,SubLogisticsIsvTraceNotifyResponseModel>("pdd.logistics.isv.trace.notify.sub",subLogisticsIsvTraceNotify);
    return result;
}
/// <summary>
/// 在线下单订单下发接口
