...
public class OrderInfo
{
    ...
    public int free_sf { get; set; }
    public int home_delivery_type { get; set; }
    public int after_sales_status { get; set; }
    public List<object> card_info_list { get; set; }
...
public class GetOrderInformationApiResult
{
    public OrderInfoGetResponse order_info_get_response { get; set; }
}
