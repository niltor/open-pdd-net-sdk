...
{
    public partial class DetailDdkLiveResponseModel : PddResponseModel
    {
        /// <summary>
        /// response
        /// </summary>
        [JsonProperty("live_detail_get_response")]
        public LiveDetailGetResponseResponseModel LiveDetailGetResponse { get; set; }
        public partial class LiveDetailGetResponseResponseModel : PddResponseModel
        {
            /// <summary>
            /// 直播间详情
            /// </summary>
            [JsonProperty("room_info")]
            public RoomInfoResponseModel RoomInfo { get; set; }
            public partial class RoomInfoResponseModel : PddResponseModel
            {
                /// <summary>
                /// 商品列表
                /// </summary>
