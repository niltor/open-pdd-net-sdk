...
{
    public partial class BatchOpenDecryptMaskResponseModel : PddResponseModel
    {
        /// <summary>
        /// response
        /// </summary>
        [JsonProperty("open_decrypt_mask_batch_response")]
        public OpenDecryptMaskBatchResponseResponseModel OpenDecryptMaskBatchResponse { get; set; }
        public partial class OpenDecryptMaskBatchResponseResponseModel : PddResponseModel
        {
            /// <summary>
            /// list
            /// </summary>
