...
{
public partial class GetFdsOrderResponseModel : PddResponseModel
{
/// <summary>
/// response
/// </summary>
[JsonProperty("pdd_fds_order_get_response")]
public PddFdsOrderGetResponseResponseModel PddFdsOrderGetResponse {get;set;}
public partial class PddFdsOrderGetResponseResponseModel : PddResponseModel
{
/// <summary>
/// 分配时间,毫秒
/// </summary>
