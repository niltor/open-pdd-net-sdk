...
namespace PddOpenSdk.Models.PddApiRequest
{
    public partial class GenDdkLotteryUrlRequestModel : PddRequestModel
    {
        ...
        public object GenerateWeappWebview { get; set; }
        /// <summary>
        /// 是否生成短链接，true-是，false-否
        /// </summary>
        [JsonProperty("generate_short_url")]
        public object GenerateShortUrl { get; set; }
        /// <summary>
        ...
        public object MultiGroup { get; set; }
        /// <summary>
        /// 自定义参数，为链接打上自定义标签。自定义参数最长限制64个字节。
        /// </summary>
        [JsonProperty("customer_paramters")]
        public object CustomerParamters { get; set; }
