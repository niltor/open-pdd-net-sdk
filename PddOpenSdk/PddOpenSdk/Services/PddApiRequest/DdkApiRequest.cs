...
/// 多多客工具生成店铺优惠券推广链接API
/// </summary>
public async Task<GenDdkOauthMallCouponUrlResponseModel> GenDdkOauthMallCouponUrlAsync(GenDdkOauthMallCouponUrlRequestModel genDdkOauthMallCouponUrl)
{
    var result = await PostAsync<GenDdkOauthMallCouponUrlRequestModel,GenDdkOauthMallCouponUrlResponseModel>("pdd.ddk.oauth.mall.coupon.url.gen",genDdkOauthMallCouponUrl);
    return result;
}
/// <summary>
/// 多多客工具生成店铺推广链接API
