...
dic.Add("voucher_no",VoucherNo);
    ...
    var result = Post<SendVoucherAppointmentInfoApiResult>("pdd.voucher.appointment.info.send",dic);
...
dic.Add("voucher_no",VoucherNo);
    ...
    var result = Post<SendVoucherPhysicalGoodsApiResult>("pdd.voucher.physical.goods.send",dic);
...
dic.Add("voucher_no",VoucherNo);
    ...
    var result = Post<VerificationVoucherVirtualCardApiResult>("pdd.voucher.virtual.card.verification",dic);
...
dic.Add("voucher_no",VoucherNo);
    ...
    var result = Post<ComplainVoucherVoucherApiResult>("pdd.voucher.voucher.complain",dic);
...
dic.Add("voucher_no",VoucherNo);
    ...
    var result = Post<SendVoucherVoucherInfoApiResult>("pdd.voucher.voucher.info.send",dic);
