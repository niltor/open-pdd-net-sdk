...
dic.Add("logistics_id",LogisticsId);
    ...
    var result = Post<SyncErpOrderApiResult>("pdd.erp.order.sync",dic);
...
dic.Add("order_sn",OrderSn);
    ...
    var result = Post<GetOrderInformationApiResult>("pdd.order.information.get",dic);
...
dic.Add("page_size",PageSize);
    ...
    var result = Post<GetOrderListApiResult>("pdd.order.list.get",dic);
...
dic.Add("page",Page);
    ...
    var result = Post<GetOrderNumberListApiResult>("pdd.order.number.list.get",dic);
...
dic.Add("page_size",PageSize);
    ...
    var result = Post<GetOrderNumberListIncrementApiResult>("pdd.order.number.list.increment.get",dic);
...
dic.Add("order_sns",OrderSns);
    ...
    var result = Post<GetOrderStatusApiResult>("pdd.order.status.get",dic);
